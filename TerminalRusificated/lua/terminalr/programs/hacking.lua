...
TerminalR.Programs["hacking"].Paint = function( self, w, h )
	...
	draw.SimpleText( TerminalR.Lang.Errors .. " : " .. self:GetMemory( "CodeError" ) .. "/" .. self:GetMemory( "CodeLimit" ) , "TrmR_Large", w*0.02, h*0.05, cclr, 0, 1 )	
	draw.SimpleText( TerminalR.Lang.HackScore .. " : " .. ChatLeft, "TrmR_Large", w*0.02, h*0.1, cclr, 0, 1 )	
	draw.SimpleText( TerminalR.Lang.HackTimeLeft .. " : " .. TimeLeft, "TrmR_Large", w*0.02, h*0.15, cclr, 0, 1 )	
	draw.SimpleText( "[" .. self:GetMemory( "Code" ) .. "]", "TrmR_Large", w*0.02, h*0.45, cclr, 0, 1 )	
	draw.SimpleText( TerminalR.Lang.Press .. " : [" .. self:GetMemory( "CodeTarget" ) .. "]", "TrmR_Large", w*0.02, PosY, cclr, 0, 1 )	
end
